...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lytTabStatistics = QtWidgets.QWidget()
        self.lytTabStatistics.setObjectName("lytTabStatistics")
        self.statsPageLayout = QtWidgets.QVBoxLayout(self.lytTabStatistics)
        self.statsPageLayout.setObjectName("statsPageLayout")
        self.horizontalLayout_59 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_59.setObjectName("horizontalLayout_59")
        self.statsHeatmap = QtWidgets.QWidget(self.lytTabStatistics)
        self.statsHeatmap.setObjectName("statsHeatmap")
        self.horizontalLayout_59.addWidget(self.statsHeatmap)
        self.lblStatsWC = QtWidgets.QLabel(self.lytTabStatistics)
        self.lblStatsWC.setMinimumSize(QtCore.QSize(10, 0))
        self.lblStatsWC.setText("")
        self.lblStatsWC.setObjectName("lblStatsWC")
        self.horizontalLayout_59.addWidget(self.lblStatsWC)
        self.lblStatsProgress = QtWidgets.QLabel(self.lytTabStatistics)
        self.lblStatsProgress.setMinimumSize(QtCore.QSize(100, 6))
        self.lblStatsProgress.setMaximumSize(QtCore.QSize(200, 14))
        self.lblStatsProgress.setText("")
        self.lblStatsProgress.setObjectName("lblStatsProgress")
        self.horizontalLayout_59.addWidget(self.lblStatsProgress)
        self.statsPageLayout.addLayout(self.horizontalLayout_59)
        self.tabMain.addTab(self.lytTabStatistics, "")
        ...
        self.verticalLayout_41 = QtWidgets.QVBoxLayout(self.tab_21)
        self.verticalLayout_41.setObjectName("verticalLayout_41")
        self.treeDebugStuff = QtWidgets.QTreeView(self.tab_21)
        self.treeDebugStuff.setObjectName("treeDebugStuff")
        self.verticalLayout_41.addWidget(self.treeDebugStuff)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabMain.setTabText(self.tabMain.indexOf(self.lytTabStatistics), _translate("MainWindow", "Statistics"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_21), _translate("MainWindow", "Statistics"))
